...
import (
	...
	"github.com/Evengard/rclone/vfs/vfscache/downloaders"
	"github.com/Evengard/rclone/vfs/vfscache/writeback"
)
...
func (item *Item) _ensure(offset, size int64) (err error) {
	...
	if item.downloaders == nil {
		...
		// See: https://github.com/Evengard/rclone/issues/6190
		// See: https://github.com/Evengard/rclone/issues/6235
		if item.o == nil {
