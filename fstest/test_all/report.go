...
<tr><th>Branch</th><td><a href="https://github.com/Evengard/rclone/tree/{{ .Branch }}">{{ .Branch }}</a></td></tr>
{{ if .Commit}}<tr><th>Commit</th><td><a href="https://github.com/Evengard/rclone/commit/{{ .Commit }}">{{ .Commit }}</a></td></tr>{{ end }}
