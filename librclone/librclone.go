...
//
//	go build --buildmode=c-shared -o librclone.so github.com/Evengard/rclone/librclone
//
// Build a static library like this:
//
//	go build --buildmode=c-archive -o librclone.a github.com/Evengard/rclone/librclone
//
...
import (
	...
	"github.com/Evengard/rclone/librclone/librclone"

	_ "github.com/Evengard/rclone/backend/all"   // import all backends
	_ "github.com/Evengard/rclone/cmd/cmount"    // import cmount
	_ "github.com/Evengard/rclone/cmd/mount"     // import mount
	_ "github.com/Evengard/rclone/cmd/mount2"    // import mount2
	_ "github.com/Evengard/rclone/fs/operations" // import operations/* rc commands
	_ "github.com/Evengard/rclone/fs/sync"       // import sync/*
